...
/**
 * Botón para agregar una {@link Modelos.Moneda} de 100 a la {@link Modelos.Billetera} del {@link Modelos.Comprador}.
 */
public class BotonAgregarMoneda100Billetera extends JButton {
     ...
     */
    public BotonAgregarMoneda100Billetera(URL rutaImagen, PanelBilletera panelBilletera, BotonAgregarSaldo boton) {
     ...
     * Agrega una {@link Modelos.Moneda} de 100 a la {@link Modelos.Billetera} del {@link Modelos.Comprador} si hay espacio.
     * Si no hay espacio, muestra un mensaje de error personalizado.
     */
    private class OyenteBoton implements ActionListener {
        @Override
        public void actionPerformed(ActionEvent ae) {
            if (getComprador().billetera.getCantMonedas(100) < 21)
